      ...
      <div className={style.MainWindow}>
        <header className={style.header}>
          <div className={style.title}>
            ...
            <div className={style.opener} onClick={() => { setMenu(menu === "open" ? "close" : "open") }}>
        ...
        <main className={style.main}>
          ...
          <div className={style.image}>
            ...
            <div className={style.LdsDualRing} style={{ display: image === "loading" ? "inline-block" : "none" }}></div>
            <img ref={imgHandler} style={{ display: "none" }} />
          </div>
          <input type='file' ref={inputImage} accept="image/*" style={{ display: 'none' }}
            onChange={(e) => {
              // Set Loading
              imgHandler.current.style.display = "none"
              setImage("loading")
